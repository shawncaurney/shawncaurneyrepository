...
**Количество созданных подсетей : 2 в 3 степени = 8** *(из заимствованных 3 бит)*

**Количество бит узлов подсети : 32 - 27 = 5** *(общее количество бит минус оставшиеся биты в новой маске подсети)*
...
3. Адрес первого узла - на 00001; *все нули, в конце - 0*
4. Адрес последнего узла - на 11110. *все единицы, в конце -1*
